...
class CometsRobot : public frc::IterativeRobotBase {
 public:
  static constexpr auto kDefaultPeriod = 10_ms;
   ...
   * @param period Period.
   */
  explicit CometsRobot(units::second_t period = kDefaultPeriod);

  ~CometsRobot() override;

  CometsRobot(CometsRobot&&) = default;
  CometsRobot& operator=(CometsRobot&&) = default;
